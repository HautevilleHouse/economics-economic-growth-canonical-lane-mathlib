...
def mathlibProofObligation : MathlibProofObligation :=
  { sourceKey := sourceRepository,
    ...
    carriedGap := "theorem-specific Growth endgame pilot closes over the admitted class; unrestricted classical closure remains carried"
  }
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedGrowthClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_growth_endgame A
